...
class AppTheme {
  ...
  static ThemeData get lightTheme {
    ...
    return ThemeData(
      ...
      textTheme: baseTextTheme.copyWith(
        ...
        titleLarge: baseTextTheme.titleLarge?.copyWith(color: AppColors.textPrimary, fontWeight: FontWeight.bold),
    ...
    return ThemeData(
      ...
      elevatedButtonTheme: ElevatedButtonThemeData(
        style: _elevatedButtonTheme.style?.copyWith(
          backgroundColor: MaterialStateProperty.all(AppColors.primary), // Keep primary button color
          foregroundColor: MaterialStateProperty.all(AppColors.textPrimaryDark), // Ensure text is readable
        )
      ),
      textButtonTheme: TextButtonThemeData(
         style: _textButtonTheme.style?.copyWith(
           foregroundColor: MaterialStateProperty.all(AppColors.primaryLight), // Lighter primary for text button
         )
      ),
      outlinedButtonTheme: OutlinedButtonThemeData(
         style: _outlinedButtonTheme.style?.copyWith(
            foregroundColor: MaterialStateProperty.all(AppColors.primaryLight), // Lighter primary
            side: MaterialStateProperty.all(BorderSide(color: AppColors.primaryLight)),
         )
      ),
      textTheme: baseTextTheme.copyWith(
        ...
        titleLarge: baseTextTheme.titleLarge?.copyWith(color: AppColors.textPrimaryDark, fontWeight: FontWeight.bold),
        titleMedium: baseTextTheme.titleMedium?.copyWith(color: AppColors.textPrimaryDark, fontWeight: FontWeight.w600),
        labelLarge: baseTextTheme.labelLarge?.copyWith(color: AppColors.textPrimaryDark, fontWeight: FontWeight.w600, letterSpacing: 0.5),
        headlineMedium: baseTextTheme.headlineMedium?.copyWith(color: AppColors.textPrimaryDark, fontWeight: FontWeight.bold),
        // Ensure hint colors are appropriate
        bodySmall: baseTextTheme.bodySmall?.copyWith(color: AppColors.textHintDark),
      ),
      inputDecorationTheme: _inputDecorationTheme.copyWith(
        ...
        focusedBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(15),
          borderSide: BorderSide(color: AppColors.primaryLight, width: 2), // Lighter focus border
        ),
        border: OutlineInputBorder(
          borderRadius: BorderRadius.circular(15),
          borderSide: BorderSide(color: AppColors.dividerDark),
      ...
      bottomNavigationBarTheme: _bottomNavBarTheme.copyWith(
        ...
        selectedItemColor: AppColors.primaryLight, // Lighter primary for selected items
        unselectedItemColor: AppColors.textSecondaryDark,
      ),
      chipTheme: _chipTheme.copyWith(
        backgroundColor: AppColors.backgroundDarkElevated,
        selectedColor: AppColors.primaryLight,
        labelStyle: baseTextTheme.labelMedium?.copyWith(color: AppColors.textPrimaryDark),
  ...
  static ColorScheme get _darkColorScheme {
    return ColorScheme(
      primary: AppColors.primaryLight, // Use lighter primary for dark theme interactions
      primaryContainer: AppColors.primary, // Can keep original primary for accents
      secondary: AppColors.secondaryLight, // Use lighter secondary
      secondaryContainer: AppColors.secondary,
      surface: AppColors.cardDark, // Dark surface
      ...
      onSurface: AppColors.textPrimaryDark, // Light text on dark surface
      onBackground: AppColors.textPrimaryDark, // Light text on dark background
