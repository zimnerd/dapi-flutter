...
class AppColors {
  ...
  static const Color textHintDark = Color(0xFF888888);     // Keep same hint color or slightly lighter
  static const Color backgroundDark = Color(0xFF121212);   // Very Dark Gray (Material Guideline)
  static const Color backgroundDarkElevated = Color(0xFF1E1E1E); // Slightly lighter for elevated surfaces
  ...
  static const Color dislike = Color(0xFFB388EB);        // Lavender Purple for dislikes
  static const Color superLike = Color(0xFFFFE66D);      // Soft Yellow for super likes
