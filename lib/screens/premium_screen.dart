...
class PremiumScreen extends StatelessWidget {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            // Feature List
            _buildFeatureItem(Icons.swipe_right_alt_outlined,
                'Unlimited Swipes', 'Never run out of profiles to see.'),
            _buildFeatureItem(
                Icons.favorite_border_outlined,
                'See Who Likes You',
                'Match instantly by seeing who already liked you.'),
            _buildFeatureItem(Icons.undo_outlined, 'Undo Last Swipe',
                'Accidentally swiped left? Get a second chance.'),
            _buildFeatureItem(Icons.visibility_outlined, 'Read Receipts',
                'Know when your messages have been read.'),
            _buildFeatureItem(
                Icons.trending_up_outlined,
                'Profile Boost (Monthly)',
                'Get seen by more people for 30 minutes.'), // Example
            _buildFeatureItem(Icons.no_accounts_outlined, 'Ad-Free Experience',
                'Enjoy the app without interruptions.'), // Example
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color:
                isPopular ? AppColors.accent : Theme.of(context).dividerColor,
            width: isPopular ? 2 : 1,
          ),
  ...
  void _handlePurchase(BuildContext context, String planId) {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
          content:
              Text('Subscription purchase for $planId not implemented yet.')),
    );
  }
}
