  ...
  List<Event> _getMockEvents() {
    return [
      Event(
        ...
        description:
            'Join us for a relaxing yoga session in Central Park. All skill levels welcome!',
      ...
      Event(
        ...
        description:
            'Sample different coffee varieties from around the world and meet new people!',
        location: 'Brew House Cafe, Brooklyn',
        dateTime: DateTime.now().add(const Duration(days: 5)),
        imageUrl:
            'https://images.unsplash.com/photo-1511920170033-f8396924c348?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60',
        attendees: 24,
        category: 'Food & Drink',
        isFree: false,
        price: 15.0,
      ...
      Event(
        ...
        description:
            'A moderate 5-mile hike with beautiful views. Great opportunity to meet fellow nature lovers!',
      ...
      Event(
        ...
        description:
            'Enjoy wine while painting a masterpiece! No experience necessary, instructor will guide you step by step.',
        location: 'Art Studio Loft, Manhattan',
        dateTime: DateTime.now().add(const Duration(days: 4)),
        imageUrl:
            'https://images.unsplash.com/photo-1577896852618-320e1f882636?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60',
        attendees: 35,
        category: 'Art',
        isFree: false,
        price: 45.0,
      ...
      Event(
        ...
        description:
            'Learn to dance salsa with professional instructors. Singles welcome - partners will rotate throughout the evening.',
        location: 'Dance Studio 54, Queens',
        dateTime: DateTime.now().add(const Duration(days: 6)),
        imageUrl:
            'https://images.unsplash.com/photo-1504609813442-a9924e2e4531?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60',
        attendees: 28,
        category: 'Dance',
        isFree: false,
        price: 20.0,
      ...
      Event(
        ...
        description:
            'Fun night of board games and meeting new people. Games provided, but feel free to bring your favorites!',
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(
                          content:
                              Text('RSVP to "${event.title}" coming soon!'),
                          backgroundColor: AppColors.primary,
                        ),
                      );
                    },
...
class Event {
  ...
  Event({
    ...
    this.price,
  }) : assert(isFree || price != null,
            'Price must be provided for non-free events');
}
